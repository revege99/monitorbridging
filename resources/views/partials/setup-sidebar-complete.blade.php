...
@endphp
<section>
    <a href="{{ route('service-monitor.index') }}" data-service-monitor-link class="flex h-10 w-full items-center gap-2 rounded-2xl px-0 text-left text-white transition hover:bg-white/5">
